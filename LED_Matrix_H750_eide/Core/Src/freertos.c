...
/* Definitions for renderDma */
osThreadId_t renderDmaHandle;
const osThreadAttr_t renderDma_attributes = {
  .name = "renderDma",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_StartRenderDma */
/**
* @brief Function implementing the renderDma thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartRenderDma */
__weak void StartRenderDma(void *argument)
{
  /* USER CODE BEGIN StartRenderDma */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
